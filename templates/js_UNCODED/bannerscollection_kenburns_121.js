				    ...
				    current_obj.msiInterval=setInterval(function() {
						...
						if ( (nowx-current_obj.msiInitialTime) > (cur_duration*1000) ) {
							...
							if (cur_verticalPosition=='bottom') {
        	  				...
        	  				current_obj.current_imgInside.css({filter:'progid:DXImageTransform.Microsoft.Matrix(FilterType="bilinear",M11='+curZoom+', M12=0, M21=0, M22='+curZoom+', Dx=' + cur_marginLeft + ',Dy=' + cur_marginTop + ')'}), current_obj.current_imgInside.css({ "-ms-filter":'progid:DXImageTransform.Microsoft.Matrix(FilterType="bilinear",M11='+curZoom+', M12=0, M21=0, M22='+curZoom+', Dx=' + cur_marginLeft + ',Dy=' + cur_marginTop + ')'});
							current_obj.current_imgInside.css({"-ms-filter":'progid:DXImageTransform.Microsoft.Matrix(FilterType="bilinear",M11='+curZoom+', M12=0, M21=0, M22='+curZoom+', Dx=' + cur_marginLeft + ',Dy=' + cur_marginTop + ')'}), current_obj.current_imgInside.css({ "-ms-filter":'progid:DXImageTransform.Microsoft.Matrix(FilterType="bilinear",M11='+curZoom+', M12=0, M21=0, M22='+curZoom+', Dx=' + cur_marginLeft + ',Dy=' + cur_marginTop + ')'});
						}
    				}, 25);
				} else {
						...
						current_obj.current_imgInside.css("-webkit-transform","scale("+zoomVal+")");
